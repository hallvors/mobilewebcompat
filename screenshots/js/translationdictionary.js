var translationDictionary = {
    ...
    "it" : {
		"Go through images with prev/next buttons below or left/right arrow button":"Scorri le immagini con i pulsanti \"avanti/indietro\" o le frecce \"destra/sinistra\"",
		" Skip screenshots for sites with open bugs":"Salta gli screenshot dei siti con bug tibcket aperti",
		"If you notice an issue that's not reported, please test to check that it's a real issue. You can pre-fill some values in Bugzilla from this form:" : "Se noti un problema che non è segnalato, sei pregato di verificare se è un vero problema. Puoi precompilare alcuni campi del form di Bugzilla da qui:",
		"Current bugs": "Bug Correnti",
		"URL:": "URL:",
		"Type problem:": "Tipo di problema:",
		"sends desktop site to":"sends desktop site to",
		"sends simplified site to":"sends simplified site to",
		"sends wap content to":"sends wap content to",
		"has broken layout in":"has broken layout in",
		"does not play video in":"does not play video in",
		"Summary: ":"Riassunto: ",
		"Whiteboard: ": "Whiteboard: ",
		"Further comments:": "Altri commenti (in inglese):",
		"HTTP header check: ": "Verifica Header HTTP: ",
		"Check now": "Verifica adesso",
		"Send to bugzilla":"Invia su Bugzilla",
		"Note: click \"Submit bug\" on the next screen to finish reporting the issue.": "Nota: cliccando su \"Submit bug\" (\"Invia Bug\") nella schermata seguente la segnalazione sarà terminata.",
		"What's this about?": "Di cosa si tratta?",
		"In short: ": "In breve: ",
		"find ":"cerca ",
		"sites that give Firefox OS a worse user experience than other smartphones, ":" siti che su Firefox OS hanno una brutta user experience rispetto agli altri smartphone e ",
		"report bugs": "segnala un problema",
		" so that we can follow up. Perhaps you'd like to watch a ": " cosi possiamo seguire il suo sviluppo. Forse ti piacerebbe guardare uno ",
	    "screencast explaining screenshot reviews": "screencast che spiega come fare questa revisione",
	    "?": "?",
	    "Cool, how?": "Interessante, ma come funziona?",
	    "Scroll through screenshots until you find one where the left and right screenshots look different, the left seems like a worse user experience, and the \"Current bugs\" list is empty.\n\t": "Scorri le immagini finchè non trovi quello dove gli screenshot a destra e sinistra hanno un'aspetto diverso, la sinistra ha una peggiore esperienza utente e i \"Bug correnti\" non sono presenti\n\t",
	    "Optionally use the \"HTTP header check\" feature and if the response is interesting, click OK to insert into the form\n\t": "Opzionalmente usa la feature \"Verifica Header HTTP\" e se la rispsota è interessante clicca ok per inserirlo nel modulo.\n\t",
	    "Click \"Send to bugzilla\"-button, and on the next page scroll down and click \"Submit bug\". (You will need an account at bugzilla.mozilla.org for this step)\n\t": "Clicca \"Invia su Bugzilla\" e nella pagina successiva clicca su \"Submit Bug\" (è necessario possedere un account su bugzilla.mozilla.org per questo passaggio)\n\t",
	    "Go back (two steps) to this page and keep scrolling through screenshots as long as you wish.\n": "Torna indietro di due passaggi in questa pagina e scorri tra gli screenshot per ricominciare.\n",
	    "Gotchas?": "Trucchi?",
	    "It can be helpful to test on a real Firefox OS phone or an emulator if in doubt..\n\t": "Può essere molto utile testare su un dispositivo Firefox OS reale o con un simulatore in caso di dubbi..\n\t",
	    "If one of the screenshots looks like it didn't load fully, it probably needs manual testing to see if it's an issue. You can ignore those screenshots if you don't have a device\n\t": "Se uno degli screenshot sembra incompleto , probabilmente richiede un test manuale per verificare il problema. Puoi ignorare questi screenshot se non hai un dispositivo.\n\t",
	    "The ": "La lista di ",
	    "current bugs": "bug correnti",
	    " list is updated every two hours, so you will not see your bug reports appear immediately. (Also if somebody else is reviewing at the same time, you might report duplicate bugs.)\n\t\n": " è aggiornata con frequenza ogni due ore, quindi se non vedi la tua segnalazione apparire immediatamente devi aspettare (inoltre potrebbe esserci anche un'altra segnalazioen aperta nello stesso momento quindi ci sarebbero ticket duplicati)\n\t\n",
	    "No bugs reported for ":"nessun bug riportato per ",
		"Need help? Ask ": "hai bisogno di aiuto? Chiedi ",
		" on Twitter, hsteen@mozilla.com by E-mail or come to the #webcompat room on Mozilla's IRC server (irc.mozilla.org).": " su Twitter, o manda un E-mail a hsteen@mozilla.com, fai un salto nel chan #webcompat del server IRC di Mozilla (irc.mozilla.org).",
		"This review is completed. Thanks :)":"Revisione completata. Grazie!",
        "Write a tweet": "Fai un tweet",
        "(Add the site Twitter account!)": "(Aggiungi l'account Twitter del sito!)"
	}
};
